...
def create_fake_addresses():
  crud.create_address_with_id(111, 1111, 'primary', '3544 NW Braid Dr', 'Bend', 'OR', 97703)
  crud.create_address_with_id(112, 1111, 'vacation', '17652 Tennis Village Ct #37,', 'Sunriver', 'OR', 97707)
  crud.create_address_with_id(113, 1111, 'vacation', '63168 Peale St', 'Bend', 'OR', 97701)
...
def create_job():
  crud.create_job_with_id(11100, 111, 111, '2021-05-04 11:00:00', '2021-05-04 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11101, 111, 111, '2021-05-18 11:00:00', '2021-05-18 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11102, 111, 111, '2021-06-01 11:00:00', '2021-06-01 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11103, 111, 111, '2021-06-15 11:00:00', '2021-06-15 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11104, 111, 111, '2021-06-29 11:00:00', '2021-06-29 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11105, 111, 111, '2021-07-13 11:00:00', '2021-07-13 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11106, 111, 111, '2021-07-27 11:00:00', '2021-07-27 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11107, 111, 111, '2021-08-10 11:00:00', '2021-08-10 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11108, 111, 111, '2021-08-24 11:00:00', '2021-08-24 14:00:00', 'Standard Clean', 150)
  # crud.create_job_with_id(11109, 111, 111, '2021-09-07 11:00:00', '2021-09-07 14:00:00', 'Standard Clean', 150)
  # crud.create_job_with_id(11110, 111, 111, '2021-09-21 11:00:00', '2021-09-21 14:00:00', 'Standard Clean', 150)
  # crud.create_job_with_id(11111, 111, 111, '2021-10-05 11:00:00', '2021-10-05 14:00:00', 'Standard Clean', 150)
  crud.create_job_with_id(11112, 111, 112, '2021-05-07 8:00:00', '2021-05-07 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11113, 111, 112, '2021-05-21 8:00:00', '2021-05-21 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11114, 111, 112, '2021-06-04 8:00:00', '2021-06-04 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11115, 111, 112, '2021-06-18 8:00:00', '2021-06-18 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11116, 111, 112, '2021-07-02 8:00:00', '2021-07-02 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11117, 111, 112, '2021-07-16 8:00:00', '2021-07-16 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11118, 111, 112, '2021-07-30 8:00:00', '2021-07-30 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11119, 111, 112, '2021-08-13 8:00:00', '2021-08-13 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11120, 111, 112, '2021-08-27 8:00:00', '2021-08-27 13:00:00', 'Vacation Clean', 225)
  # crud.create_job_with_id(11121, 111, 112, '2021-09-10 8:00:00', '2021-09-10 13:00:00', 'Vacation Clean', 225)
  # crud.create_job_with_id(11122, 111, 112, '2021-09-24 8:00:00', '2021-09-24 13:00:00', 'Vacation Clean', 225)
  # crud.create_job_with_id(11123, 111, 112, '2021-10-08 8:00:00', '2021-10-08 13:00:00', 'Vacation Clean', 225)
  crud.create_job_with_id(11124, 111, 113, '2021-05-06 9:00:00', '2021-05-06 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11125, 111, 113, '2021-05-20 9:00:00', '2021-05-20 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11126, 111, 113, '2021-06-03 9:00:00', '2021-06-03 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11127, 111, 113, '2021-06-17 9:00:00', '2021-06-17 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11128, 111, 113, '2021-07-01 9:00:00', '2021-07-01 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11129, 111, 113, '2021-07-15 9:00:00', '2021-07-15 12:00:00', 'Vacation Clean', 175)
  crud.create_job_with_id(11130, 111, 113, '2021-07-29 9:00:00', '2021-07-29 12:00:00', 'Vacation Clean', 175)
